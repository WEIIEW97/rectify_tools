...
%     draw = 0;1;0;1;
    ...
    %                                     imgRect = BilinearRemap(imgRect, imgR, imgG, imgB, image, xyOrig_int_in, xyOrig_frac_in,foundIndIn);
                                        [coeff1,coeff2,coeff3,coeff4,cof1,cof2,cof3,cof4,imgRect] = BilinearRemap_coeff(imgRect, imgR, imgG, imgB, image, xyOrig_int_in, xyOrig_frac_in,foundIndIn);
                                    end
                                catch
                                    dakvhb = 1;
                                end
    ...
    function [coeff1,coeff2,coeff3,coeff4,cof1,cof2,cof3,cof4,imgRect] = BilinearRemap_coeff(imgRect, imgR, imgG, imgB, image, xyOrig_int_in, xyOrig_frac_in,foundIndIn)
